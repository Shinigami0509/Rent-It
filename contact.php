...
try {
    ...
    $stmt = $conn->prepare("UPDATE contact_form SET category = :category, name = :name, email = :email, phone = :phone, message = :message WHERE user_id = :user_id");
    ...
    $mail->Subject = 'Message from ' . $name; // Include the sender's name in the subject
  ...
  <body>
    <div class="container">
      ...
      <form action="" method="post">
        ...
        <p style="color:rgb(158, 9, 9);">All Fields Are Required*</p>
